...
namespace IIS.123456
{
    ...
    public class ОтчетОСервере : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.123456.РежимСервера fРежим;
        
        private IIS.123456.Расположение fРасположение;
        ...
        public virtual IIS.123456.РежимСервера Режим
        {
            get
            {
                ...
                IIS.123456.РежимСервера result = this.fРежим;
        ...
        [PropertyStorage(new string[] {
                "Расположение"})]
        [NotNull()]
        public virtual IIS.123456.Расположение Расположение
        {
            get
            {
                ...
                IIS.123456.Расположение result = this.fРасположение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереE", typeof(IIS.123456.ОтчетОСервере));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереL", typeof(IIS.123456.ОтчетОСервере));
                }
            }
        }
    }
