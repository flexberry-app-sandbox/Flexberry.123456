...
namespace IIS.123456
{
    ...
    public class Серверная : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.123456.Сотрудник fСотрудник;
        
        private IIS.123456.DetailArrayOfКонтроллер fКонтроллер;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.123456.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.123456.Сотрудник result = this.fСотрудник;
        ...
        public virtual IIS.123456.DetailArrayOfКонтроллер Контроллер
        {
            get
            {
                ...
                {
                    this.fКонтроллер = new IIS.123456.DetailArrayOfКонтроллер(this);
                }
                IIS.123456.DetailArrayOfКонтроллер result = this.fКонтроллер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СервернаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяE", typeof(IIS.123456.Серверная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СервернаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяL", typeof(IIS.123456.Серверная));
                }
            }
        }
    }
