...
moduleForModel('i-i-s-123456-отчет-о-сервере', 'Unit | Serializer | i-i-s-123456-отчет-о-сервере', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-123456-отчет-о-сервере',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

    'transform:i-i-s-123456-режим-сервера',
